...
const enterpriseStyle = function (provider) {
    ...
    if (provider.login_text_hex_color) {
        //str += 'border: 1px solid ' + provider.login_text_hex_color + ';';
        str += 'color:' + provider.login_text_hex_color + ';';
    }
    if (provider.login_background_hex_color) {
        str += 'background-color:' + provider.login_background_hex_color + ';';
    }
...
const svgButtons_e = function (provider, register) {
    ...
    if (provider.login_button_image_uri) {
        html =
            '<div class="custom-button" style="background-image: url(' +
            provider.login_button_image_uri +
            ');"></div>';
    }
...
const svgIcons_e = function (provider) {
    var html = '';
    let type = provider.type;
    let id = provider.identity_provider_id;
    ...
    if (provider.login_icon_image_uri) {
        html =
            '<div class="custom-icon" style="background-image: url(' +
            provider.login_icon_image_uri +
            ');"></div>';
    }
